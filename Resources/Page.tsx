...
import { ArrowRight, MessageCircle, FileText, Download, Mail, BookOpen, Layers } from "lucide-react"
...
export default function ResourcesHub() {
  return (
    <main className="min-h-screen bg-background text-foreground flex flex-col justify-between">
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-12 lg:px-8">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {guides.map((guide, i) => (
            <div 
              key={i} 
              className="bg-white border border-border rounded-2xl p-6 flex flex-col justify-between shadow-sm hover:shadow-md transition-all group"
            >
              <div>
        ...
        <div className="mx-auto w-full max-w-6xl px-6 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div key={idx} className="bg-white border border-border p-6 rounded-2xl flex flex-col justify-between shadow-inner">
                <div>
                ...
                {/* Form placeholder to sync directly with your Tally.so or Formspree integration requirements */}
                <button className="mt-6 inline-flex items-center justify-center gap-2 w-full bg-primary hover:bg-primary/95 text-white font-bold text-sm py-3 px-4 rounded-xl transition-all shadow-sm">
      ...
      {/* Inbox Newsletter Frame */}
      <section className="mx-auto w-full max-w-4xl px-6 py-16 text-center">
        <div className="bg-white border-2 border-dashed border-border p-8 md:p-12 rounded-3xl space-y-4">
          ...
          <div className="pt-4 max-w-md mx-auto flex flex-col sm:flex-row gap-2">
            <input 
              ...
              className="w-full px-4 py-3 rounded-xl border border-border text-sm font-medium focus:outline-none focus:border-accent"
            />
            <button className="bg-accent text-accent-foreground font-bold px-6 py-3 rounded-xl text-sm whitespace-nowrap shadow-sm hover:bg-accent/90">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-24 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-primary px-6 py-12 text-center text-primary-foreground shadow-xl md:px-12">
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link
              href="/services"
              className="group inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-accent px-7 py-3.5 text-base font-semibold text-accent-foreground shadow-sm transition-all hover:brightness-105"
            >
              See our services
            ...
            <a
              ...
              className="group inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/10 px-7 py-3.5 text-base font-semibold text-white shadow-sm transition-all hover:bg-white/20"
            >
