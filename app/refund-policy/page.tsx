    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-300 py-16 px-6 sm:px-8">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="border-b border-neutral-800 pb-6">
          <h1 className="text-3xl font-bold text-white tracking-tight mb-2">REFUND &amp; CANCELLATION POLICY</h1>
          <p className="text-sm text-neutral-500">EFFECTIVE DATE: July 19, 2026</p>
          <p className="text-xs text-neutral-400 mt-2 italic">This Refund &amp; Cancellation Policy forms part of our Terms of Service and should be read alongside them.</p>
        </div>
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p><strong>1.1</strong> We want you to be clear on what to expect before you pay us. This policy sets out how refunds and cancellations work across our three service tiers: Launch, Monitoring, and Advisory.</p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-white">2. Launch (One-Off Engagement)</h2>
            <p><strong>2.1</strong> Launch is a fixed-scope, one-off engagement covering CAC pre and post-incorporation filing, statutory registers setup, FIRS tax registration, and related deliverables as described on our Services page.</p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-white">3. Monitoring (Subscription)</h2>
            <p><strong>3.1</strong> Monitoring is billed monthly in advance.</p>
            <p><strong>3.2 Cancellation Timing:</strong> You may cancel your Monitoring subscription at any time. Cancellation will take effect at the end of your current billing cycle &mdash; we do not provide partial-month refunds for the cycle already in progress.</p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-white">4. Advisory (Custom Scope)</h2>
            <p><strong>4.1</strong> Advisory engagements are scoped and quoted individually before work begins, with payment terms &mdash; including any deposit, milestone, or upfront structure &mdash; confirmed in writing as part of your engagement.</p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-white text-red-400">5. What is Never Refundable</h2>
            ...
            <ul className="list-disc pl-5 space-y-1 text-neutral-400">
              ...
              <li>Payment processor fees charged by Paystack on the original transaction metadata.</li>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-white">6. How Refunds Are Processed</h2>
            <p><strong>6.1 Processing Windows:</strong> Approved refunds are processed back to the original payment method via Paystack within 10 business days of approval, subject to Paystack&apos;s own processing timelines, which sit entirely outside our control.</p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-white">7. Disputes</h2>
