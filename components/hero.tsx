  ...
  <span className="inline-flex h-[1.2em] flex-col overflow-hidden align-bottom relative font-extrabold">
    ...
    `}</style>
            ...
            >
              <Link
                href="/services"
                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-accent px-7 py-3.5 text-base font-bold text-white shadow-lg transition-all hover:bg-accent/90 hover:sca[...]"
              >
                Get Started
              ...
              <a
                ...
                className="group inline-flex items-center justify-center gap-2.5 rounded-xl bg-[#25D366] px-7 py-3.5 text-base font-bold text-white shadow-md transition-all hover:bg-[#20ba59] hove[...]"
              >
        ...
        <div className="animate-fade-in-up border border-dashed border-border bg-white p-6 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4" style={{ animationDelay: "100m[...] }}>
        ...
        <div className="bg-white/40 border border-border p-6 md:p-8 rounded-3xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <Link href="/resources" className="inline-flex w-fit items-center gap-1.5 bg-primary hover:bg-primary/95 text-white font-bold text-xs px-4 py-2.5 rounded-xl shadow-sm transition-all s[...]">
        ...
        <div className="animate-fade-in-up relative overflow-hidden rounded-3xl bg-primary px-6 py-12 text-center text-primary-foreground shadow-xl md:px-12" style={{ animationDelay: "200ms" }}>
          ...
          <p className="mt-4 text-sm text-white/80 max-w-xl mx-auto">Get your corporate registry frameworks configured and audited cleanly before structural limits block your next transaction pha[...]</p>
          <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link href="/services" className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-accent px-7 py-3.5 text-base font-bold text-white shadow-sm hover:bg-acc[...]
