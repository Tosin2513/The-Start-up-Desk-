      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col px-6 lg:px-8 h-full justify-center gap-16 my-auto">
        ...
        <div className="grid items-center gap-12 py-8 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="flex flex-col items-start space-y-6">
            ...
            <div className="animate-fade-in-up mt-8 flex w-full flex-col gap-3 sm:flex-row sm:items-center" style={{ animationDelay: "320ms" }}>
              <Link href="/services" className="group inline-flex items-center justify-center gap-2 rounded-xl bg-accent px-7 py-3.5 text-base font-bold text-white shadow-lg hover:bg-accent/90">
                Get Started
              ...
              <a
                ...
                className="group inline-flex items-center justify-center gap-2.5 rounded-xl bg-[#25D366] px-7 py-3.5 text-base font-bold text-white shadow-md hover:bg-[#20ba59]"
              >
                <svg className="h-5 w-5 fill-current text-[#25D366]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className="animate-fade-in-up bg-white/40 border border-border/60 p-8 rounded-2xl text-center max-w-3xl mx-auto space-y-4" style={{ animationDelay: "200ms" }}>
          ...
          <p className="text-base text-muted-foreground leading-relaxed font-medium">
            Most compliance problems start in your first few months because nobody hands you a clear manual. Google leaves you with ten different half answers and unexpected fines. We exist to close that gap before it becomes a hazard.
          </p>
        </div>
        ...
        <div className="mx-auto max-w-3xl py-12 text-center">
          <div className="animate-fade-in-up rounded-2xl border border-border bg-card p-8 md:p-12 shadow-sm">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-pretty text-muted-foreground">We handle the regulatory side of running a business; registration, tax, compliance, licensing so you can stay focused on building, not paperwork.</p>
          </div>
        </div>
        ...
        <div className="animate-fade-in-up border border-dashed border-border bg-white p-6 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4" style={{ animationDelay: "100ms" }}>
          <div className="flex items-center gap-3">
            ...
            <p className="text-xs text-muted-foreground font-semibold leading-relaxed">The Startup Desk was built on an experienced legal compliance background to interpret regulation into plain, actionable checklists. We are a dedicated compliance consultancy, not an active law firm, meaning we focus entirely on corporate management paperwork frameworks rather than court litigation or representation.</p>
          </div>
        </div>
