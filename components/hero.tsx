      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col px-6 py-8 lg:px-8">
        ...
        <div className="grid items-center gap-12 py-16 md:py-24 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="max-w-2xl">
            ...
            {/* Cleaned text-slider logic to prevent crowding or breaking */}
            <h1
            ...
            >
              ...
              trips founders up so you can stay focused on building, not battling deadlines.[span_0](start_span)[span_0](end_span)
            </p>
            ...
            >
              <Link
                href="/services"
                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-accent px-6 py-3.5 text-base font-semibold text-accent-foreground shadow-sm transition-all hover:bg-accent/90 hover:shadow-md focus-visible:outline-none"
              >
                Get Started
              ...
              <a
                ...
                className="group inline-flex items-center justify-center gap-2.5 rounded-xl bg-[#25D366] px-6 py-3.5 text-base font-semibold text-white shadow-sm transition-all hover:bg-[#20ba59] hover:shadow-md focus-visible:outline-none"
              >
          ...
          >
            ...
            <ul className="mt-6 flex flex-col gap-6">
              <li className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-semibold text-white">CAC filings[span_1](start_span)[span_1](end_span)</p>
                  <p className="mt-0.5 text-sm leading-relaxed text-white/70">
                    Registration, annual returns, and status changes done right.[span_2](start_span)[span_2](end_span)
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-semibold text-white">Tax registration[span_3](start_span)[span_3](end_span)</p>
                  <p className="mt-0.5 text-sm leading-relaxed text-white/70">
                    TIN, VAT, and PAYE set up correctly from day one.[span_4](start_span)[span_4](end_span)
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-semibold text-white">Regulatory paperwork[span_5](start_span)[span_5](end_span)</p>
                  <p className="mt-0.5 text-sm leading-relaxed text-white/70">
                    Permits, licenses, and filings tracked before they lapse.[span_6](start_span)[span_6](end_span)
                  </p>
                </div>
              </li>
            </ul>
