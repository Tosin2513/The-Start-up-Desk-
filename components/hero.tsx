...
export function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden animate-silk flex flex-col justify-center">
      {/* Subtle overlay to maintain elite typography contrast */}
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col px-6 py-8 lg:px-8">
        ...
        <div className="grid items-center gap-12 py-16 md:py-24 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="max-w-2xl">
            ...
            {/* FIXED HEADLINE: Block display layout stops words from crushing together */}
            <h1
            ...
            >
              ...
              <span className="block sm:inline-block min-w-[280px] text-accent mt-1 sm:mt-0">
            ...
            >
              ...
              {/* BRAND NEW BUTTON: Customized with official branding green and the accurate WhatsApp SVG Logo */}
              <a
                href={whatsappLink(
